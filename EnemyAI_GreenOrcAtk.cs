...
public class EnemyAI_GreenOrcAtk : MonoBehaviour
{
    ...
    void ShootAtPlayer(Vector2 targetPosition)
    {
        ...
        Vector2 toTarget = targetPosition - (Vector2)firePoint.position;
        Vector2 velocity = CalculateLaunchVelocity(toTarget, targetPosition);
